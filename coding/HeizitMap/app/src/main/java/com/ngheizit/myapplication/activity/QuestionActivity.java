...
public class QuestionActivity extends AppCompatActivity {
    ...
    private void AddQuestionsToList() {
        questionList = new Question[]{
                ...
                // ----- 第三章
                new Question("___：卫星在控件运行的轨迹", "轨道"),
                new Question("___：描述卫星轨道位置和状态的参数", "轨道参数"),
                new Question("卫星受到的作用（摄动力）：地球对卫星的___，太阳、月亮对卫星的___，大气___，太阳___，地球___", "引力，引力，阻力，光压，潮汐力"),
                new Question("___力决定卫星运动的基本规律和特征", "中心"),
                new Question("无摄卫星轨道的描述：轨道椭圆的___和___，轨道平面与地球体的___，轨道椭圆在轨道平面上的___，卫星在轨道上的___", "形状，大小，相对位置，方位，瞬时位置"),
                new Question("___(Ω)：地球赤道面上升交点与春分点之间的地心夹角", "升交点赤经"),
                new Question("___(i)：卫星轨道平面与地球赤道面之间的夹角", "轨道面倾角"),
                new Question("___ωs：在轨道平面上，升交点与近地面之间的地心夹角", "近地点角距"),
                new Question("___(ωs)：轨道平面上卫星与近地点之间的地心角距", "真近点角"),
                new Question("开普勒轨道六参数：___(a)和___(e)确定轨道大小和形状，___(i)和___(Ω)确定轨道面与赤道面的位置关系，___(ωs)确定开普勒椭圆在轨道面上的定向，___(ωs)确定卫星在轨道上的位置", "长半轴，扁率，倾角，升交点赤经，近地点角距，真近点角"),
                new Question("___：在轨运行的卫星受外力作用而产生轨道偏离椭圆的现象，以致卫星轨道变成一条复杂的封闭曲线", "摄动"),
                new Question("___：导致卫星摄动的作用力", "摄动力"),
                new Question("___：卫星在摄动力作用下的运动轨迹", "摄动轨道"),
                new Question("___：描述卫星运动轨迹的信息，是一组对应某一时刻的轨道根数及其变率", "卫星星历"),
                new Question("根据卫星星历可以计算出任一时刻的卫星___及其___", "位置，速度"),
                new Question("GPS卫星星历分为___（___）和___（___）", "预报星历，广播星历，后处理星历，精密星历"),
                new Question("___是通过卫星发射的含有轨道信心的导航电文传递给用户，经解码获得所需的卫星星历，包含相对某一参考历元的开普勒轨道参数和必要的轨道摄动项改正参数", "预报星历")
