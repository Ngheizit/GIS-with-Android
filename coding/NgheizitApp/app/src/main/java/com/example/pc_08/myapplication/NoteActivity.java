...
public class NoteActivity extends AppCompatActivity {
    ...
    private void AddQuestionsToList(){
        questionList = new Question[]{
				...
				new Question("地理数据按性质分___和___", "定性书局，定量数据"),
				new Question("地理数据在建模分析中的作用", "确定模型参数和初值，验证模型正确性、准确性和合理性"),
				new Question("地理数据特征", "形式化数量化，度空间尺度，多维性，不确定性"),
				new Question("地理数据的不确定性体现在", "位置，属性，时域，模型"),
				new Question("统计分组的定义", "按某一标志划分的若干性质不同但又有联系的部分"),
				new Question("统计指标分类", "集中趋势，离散程度，分布特征"),
