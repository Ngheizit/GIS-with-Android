    ...
    private void AddQuestionsToList() {
        questionList = new Question[]{
                ...
                new Question("GPS工作卫星的地面监控系统由___个，包含___个主控站，___个注入站，___个监控站", "5，1，3，5"),
                    // ----- 第三周
                new Question("天球以___为中心，___为半径的假象球体","地球质心，任意长度"),
                new Question("天轴为地球___延伸的直线","自转轴"),
                new Question("天球赤道面是通过___，与___垂直的平面",""),
                new Question("地球坐标系包含___坐标系和___坐标系", "地心，参心"),
                new Question("天球坐标系的三参数___,___,___","赤经，赤纬，向径"),
                new Question("大地坐标系的三参数___,___,___","大地纬度，大地经度，大地高程"),
